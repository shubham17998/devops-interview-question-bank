...
Q: Difference between Deployment and Service?\
...
Q: What role does etcd play in Kubernetes? Can Kubernetes function without it?\
...
Q: What are the worker-node components, and what does each do?\
...
Q: Difference between ReplicaSet, Deployment and StatefulSet?\
...
Q: How do you perform a Kubernetes Deployment?\
...
Q: Can Kubernetes run in a single-node local environment?\
...
Q: How do you securely store credentials in Kubernetes?\
...
Q: How do you handle node autoscaling?\
...
Q: How do you scale microservices in Kubernetes?\
...
Q: How does the Vertical Pod Autoscaler (VPA) work?\
...
Q: How do taints and tolerations work?\
...
Q: Difference between Taints/Tolerations and Node Affinity?\
...
Q: How do you run specific microservices on specific nodes?\
...
Q: Can we limit CPU and Memory at Namespace level?\
...
Q: How do Pods communicate with external databases?\
...
Q: How do you block communication between pods in the same namespace?\
...
Q: What is Kubernetes Network Policy?\
...
Q: On which resource is Network Policy applied?\
...
Q: How do you troubleshoot pod networking issues?\
...
Q: What is Blue-Green deployment in Kubernetes?\
...
Q: What are the types of deployment strategies?\
...
Q: What is the rollback strategy in Kubernetes?\
...
Q: Which type of deployment will you use for production and why?\
...
Q: What is Kubernetes API Server use case?\
...
Q: What are the steps to create an ArgoCD Project?\
...
Q: What are ArgoCD CLI commands?\
...
Q: Explain the ALB Ingress Controller workflow.\
...
Q: How does the ALB know which pods are healthy?\
...
Q: How do you update a container image in a Deployment?\
...
Q: Pod stuck in ContainerCreating state — what will you check?\
...
Q: Pods continuously crashing — how do you troubleshoot?\
...
Q: How would you troubleshoot multiple pod crashes over the last month without monitoring tools?\
...
Q: From where would you obtain one-month-old troubleshooting information?\
...
Q: CPU is spiking in production pods — what will you do?\
...
Q: If one pod shows a spike, how do you troubleshoot?\
...
Q: What happens if one node becomes unavailable?\
...
Q: What is the purpose of the PodDisruptionBudget?\
...
Q: Why did you choose Helm over plain Kubernetes manifests?\
...
Q: What are Helm charts, and how do they simplify Kubernetes deployments?\
...
Q: What are the main components of Helm?\
...
Q: What is a Helm Chart, and what does it contain?\
...
Q: What is a Chart.yaml file, and what is its purpose?\
...
Q: What is a values.yaml file, and how does it work?\
...
Q: How does Keycloak maintain sessions across multiple pods?\
