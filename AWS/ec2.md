...
Q: What are the different EC2 instance families?\
...
Q: What is the difference between burstable and non-burstable instances?\
...
Q: How do CPU credits work in T-series instances?\
...
Q: What happens when CPU credits are exhausted?\
...
Q: How do you create and use an AMI?\
...
Q: What is an Elastic Network Interface (ENI), and what role does it play in network connectivity?\
...
Q: What are EC2 purchasing options?\
...
Q: Difference between On-Demand, Reserved, Spot, and Savings Plans?\
...
## Instance Lifecycle
Q: Difference between Stop, Terminate, Reboot, and Hibernate?\
...
Q: What do you do if port 22 is closed and you cannot SSH into an EC2 instance?\
...
Q: How do you access an EC2 instance that does not have a public IP?\
...
## Auto Scaling
Q: How do you update an application in an Auto Scaling Group without downtime?\
...
Q: What is Instance Refresh in ASG?\
...
Q: Difference between a Launch Template and a Launch Configuration?\
...
Q: What are ASG scaling policies?\
...
Q: What metrics can trigger Auto Scaling?\
...
Q: How does ASG replace unhealthy instances?\
...
Q: How do you scale applications based on SQS queue depth?\
...
Q: How would you design a highly available and scalable application using ASG?\
...
Q: How do you create 10 EC2 instances with incrementing names/values (e.g., web-0, web-1, web-2)?\
...
Q: How would you terminate 9 out of 10 running EC2 instances and leave exactly one running?\
...
Q: What is an EC2 Instance Profile, and how is it used to grant permissions to an EC2 instance?\
...
Q: What is the EC2 Instance Metadata Service, and how can you use it from within an instance?\
...
Q: What is EC2 User Data, and how can you use it to automate instance configuration during launch?\
...
## Disaster Recovery
Q: How can you perform disaster recovery for EC2 in another region?\
