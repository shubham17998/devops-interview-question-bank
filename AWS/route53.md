...
8. Q: Difference between Alias and CNAME?
   Ans:
   | | Alias | CNAME |
   |---|---|---|
...
## Health Checks
13. Q: What are Route53 Health Checks?
...
## DNS Troubleshooting
14. Q: How do DNS resolution and Route53 work?
...
15. Q: What should you check when DNS resolution fails?
    Ans:
...
## Scenarios
16. Q: You want to redirect traffic from x.company.in to company.in/x. How would you achieve it?
