...
## OSI & TCP/IP Models
Q: What are the OSI layers, and how does each function?\
Ans:
...
Q: Between the OSI and TCP/IP models, which one is better to implement and why?\
...
Q: What exactly is the TCP/IP model?\
...
Q: What is the difference between TCP and UDP? Where would you use each?\
...
## IP Addressing
Q: What is CIDR, and why is it used?\
...
Q: How many bytes are there in IPv4 and IPv6 addresses?\
Ans: IPv4 = 4 bytes (32 bits). IPv6 = 16 bytes (128 bits).

Q: What differentiates a logical address from a physical address?\
...
Q: How do a MAC address and an IP address differ in function?\
...
Q: What is the difference between a Load Balancer, a Reverse Proxy, and an Ingress?\
...
Q: What is the DNS resolution sequence when you look up a URL like www.example.com?\
...
Q: In a FQDN like www.example.com, what are the root, top-level domain, second-level domain, and domain?\
...
Q: What is a DNS record, and what types of DNS records exist (A, AAAA, CNAME, PTR, MX, NS)?\
...
Q: Can DNS be used for load balancing? How?\
